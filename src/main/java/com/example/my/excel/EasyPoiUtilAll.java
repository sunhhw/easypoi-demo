...
import com.example.my.excel.EasyPoiExcelStyleUtil;
...
public class EasyPoiUtilAll {
     ...
     * @return
     */
    public static <T> List<T> importExcel(String filePath, int sheetIndex,
    ...
    private static Workbook getWorkbook(ExcelType type, int size) {
        if (ExcelType.HSSF.equals(type)) {
            ...
            return (Workbook) (size < 1 ? new XSSFWorkbook()
                    : new SXSSFWorkbook());
        }
    }
